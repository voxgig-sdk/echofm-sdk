...
from echofm_sdk.utility.voxgig_struct import voxgig_struct as vs
from echofm_sdk import EchofmSDK
from echofm_sdk.core.spec import EchofmSpec
from echofm_sdk.core.result import EchofmResult
from echofm_sdk.core.response import EchofmResponse
from echofm_sdk.core.operation import EchofmOperation
from echofm_sdk.core.error import EchofmError
from echofm_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = EchofmSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = EchofmSDK.test(None, None)
        ...
        class TestInitFeature(EchofmBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(EchofmBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = EchofmSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = EchofmSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = EchofmSDK.test(None, setup_opts)
