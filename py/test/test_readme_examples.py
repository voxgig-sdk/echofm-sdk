# Echofm SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EchofmSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EchofmSDK(...) and EchofmSDK.test(...) become
#      EchofmSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "echofm_sdk"
_SDK_CLASS = "EchofmSDK"
