...
from echofm_sdk.utility import register

# Load features
from echofm_sdk.feature.base_feature import EchofmBaseFeature
from echofm_sdk.features import _has_feature, _make_feature
...
class EchofmSDK:
    ...
    def get_utility(self):
        return EchofmUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EchofmSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Post(self, data=None) -> "PostEntity":
        ...
        from echofm_sdk.entity.post_entity import PostEntity
        return PostEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "EchofmSDK":
        if sdkopts is None:
            sdkopts = {}
