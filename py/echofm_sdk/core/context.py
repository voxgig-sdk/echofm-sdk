...
from echofm_sdk.core.helpers import get_ctx_prop, to_map
...
class EchofmContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, EchofmResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return EchofmError(code, msg, self)
