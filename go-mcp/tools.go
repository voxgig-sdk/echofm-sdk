...
func registerTools(server *mcp.Server, client *sdk.EchofmSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "echofm_list",
		Description: "List records from Echofm. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "echofm_load",
		Description: "Load a single record from Echofm. " +
...
func runOp(client *sdk.EchofmSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EchofmSDK, name string) (sdk.EchofmEntity, error) {
