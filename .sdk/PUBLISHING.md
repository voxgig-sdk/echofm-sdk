...
|---|---|---|
| `ts/` | @voxgig-sdk/echofm-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/echofm-sdk \
      --repository voxgig-sdk/echofm-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/echofm-sdk` shows it, and
`npm trust revoke @voxgig-sdk/echofm-sdk --id=<id>` removes it.
