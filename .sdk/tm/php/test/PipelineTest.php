...
{
    private static function utility(): EchofmUtility
    {
        return new EchofmUtility();
    }
    ...
    private static function ctx(array $over = []): EchofmContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new EchofmContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new EchofmOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof EchofmError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new EchofmOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = EchofmMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new EchofmOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = EchofmMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new EchofmOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = EchofmMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EchofmSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = EchofmMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new EchofmResponse([]),
            'result' => new EchofmResult([]),
        ]);
        [, $err] = EchofmMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new EchofmSpec(['step' => 's']),
            'response' => new EchofmResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new EchofmResult([]),
        ]);
        [, $err] = EchofmMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new EchofmSpec(['step' => 's']),
            'response' => new EchofmResponse(self::resp(200, ['v' => 1])),
            'result' => new EchofmResult([]),
        ]);
        [, $err] = EchofmMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new EchofmSpec(['step' => 's']),
            'response' => new EchofmResponse(self::resp(200, ['v' => 2])),
            'result' => new EchofmResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        EchofmMakeResponse::call($ctx);
    ...
    {
        $preset = new EchofmResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new EchofmSpec([]),
            'response' => new EchofmResponse([]),
            'result' => new EchofmResult([]),
        ...
        [$got, $err] = EchofmMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new EchofmResult([])]);
        [, $err] = EchofmMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new EchofmSpec([]), 'result' => null]);
        [, $err] = EchofmMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EchofmSpec(['step' => 's']),
            'result' => new EchofmResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new EchofmOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EchofmMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EchofmSpec(['step' => 's']),
            'result' => new EchofmResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new EchofmOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EchofmMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EchofmResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new EchofmSpec([]),
            'result' => new EchofmResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = EchofmMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EchofmMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new EchofmError('boom', 'boom');
        $utility->fetcher = function (EchofmContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EchofmSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = EchofmMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (EchofmContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = EchofmMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(EchofmResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (EchofmContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EchofmSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = EchofmMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new EchofmResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new EchofmSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = EchofmMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = EchofmMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = EchofmMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new EchofmResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, EchofmDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new EchofmResult(['ok' => false])]);
        $this->expectException(EchofmError::class);
        EchofmDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new EchofmResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', EchofmMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new EchofmBaseFeature();
        $b = new EchofmBaseFeature();
        EchofmFeatureAdd::call($ctx, $a);
        EchofmFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): EchofmBaseFeature
    {
        $f = new EchofmBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        EchofmFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): EchofmContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new EchofmSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EchofmPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new EchofmResponse(['headers' => null]),
            'result' => new EchofmResult([]),
        ]);
        EchofmResultHeaders::call($ctx);
