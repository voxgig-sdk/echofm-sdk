...
// Echofm SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EchofmMakeRequest
{
    public static function call(EchofmContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EchofmResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EchofmResponse($fetched);
        } else {
