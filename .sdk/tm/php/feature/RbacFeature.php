...
class EchofmRbacFeature extends EchofmBaseFeature
{
    ...
    private function _required(EchofmContext $ctx): ?string
    {
    ...
    private function _reject(EchofmContext $ctx, string $required): void
    {
    ...
    private function _track(EchofmContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
