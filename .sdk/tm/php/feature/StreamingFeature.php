...
class EchofmStreamingFeature extends EchofmBaseFeature
{
    ...
    private function _iterate(EchofmResult $result): \Generator
    {
    ...
    private function _streamable(EchofmContext $ctx): bool
    {
