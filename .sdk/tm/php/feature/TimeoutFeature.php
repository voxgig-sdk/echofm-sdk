...
class EchofmTimeoutFeature extends EchofmBaseFeature
{
    ...
    private function _with_timeout(EchofmContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EchofmContext $_ctx, float $ms): void
    {
        $client = $this->client;
