...
// Echofm SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class EchofmTestFeature extends EchofmBaseFeature
{
    ...
    public function init(EchofmContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (EchofmContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (EchofmContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(EchofmContext $ctx, $op, $args): array
    {
