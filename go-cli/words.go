...
func registerSDKWords(r *eng.Registry, client *sdk.EchofmSDK) {
...
func runOp(client *sdk.EchofmSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
