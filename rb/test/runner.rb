...
module EchofmTestRunner
  ...
  def self.env_override(m)
    live = getenv("ECHOFM_TEST_LIVE")
    override = getenv("ECHOFM_TEST_OVERRIDE")
    ...
    explain = getenv("ECHOFM_TEST_EXPLAIN")
    m["ECHOFM_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = EchofmTestRunner
Helpers = EchofmHelpers
Vs = VoxgigStruct
