...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = EchofmOmni.make_runner(TEST_JSON_FILE, EchofmSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : EchofmOmni.errify(err)
    end
