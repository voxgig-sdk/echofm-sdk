...
EchofmSDK._make_feature = _make_feature


function EchofmSDK.new(options)
  local self = setmetatable({}, EchofmSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function EchofmSDK:options_map()
...
function EchofmSDK:get_utility()
  return Utility.copy(self._utility)
end


function EchofmSDK:get_root_ctx()
  return self._rootctx
end


function EchofmSDK:prepare(fetchargs)
...
function EchofmSDK:direct(fetchargs)
...
-- by passing it.
function EchofmSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function EchofmSDK:graphql(query, variables, ctrl)
...
function EchofmSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = EchofmSDK.new(sdkopts)
  sdk.mode = "test"
