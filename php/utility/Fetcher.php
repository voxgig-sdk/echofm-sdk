...
class EchofmFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EchofmSDK/1.0)';
    ...
    public static function call(EchofmContext $ctx, string $fullurl, array $fetchdef): array
    {
