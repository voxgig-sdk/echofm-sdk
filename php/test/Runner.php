...
class EchofmTestRunner
{
    ...
    {
        $live = self::getenv('ECHOFM_TEST_LIVE');
        $override = self::getenv('ECHOFM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ECHOFM_TEST_EXPLAIN');
...
class_alias('EchofmTestRunner', 'Runner');
class_alias('EchofmHelpers', 'Helpers');
