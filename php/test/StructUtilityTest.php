...
// Echofm SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = EchofmOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(EchofmOmni::structfix($now, Struct::undef()))
                        !== json_encode(EchofmOmni::structfix($val, Struct::undef()))) {
