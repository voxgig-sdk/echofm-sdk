...
// Echofm SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EchofmSDK::test)
...
{
    private const SDK_CLASS = 'EchofmSDK';
    ...
    private const SDK_BASE = 'echofm_sdk';
