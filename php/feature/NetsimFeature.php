...
class EchofmNetsimFeature extends EchofmBaseFeature
{
    ...
    private function _simulate(EchofmContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EchofmContext $ctx, array $applied): void
    {
        $client = $this->client;
