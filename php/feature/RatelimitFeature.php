...
class EchofmRatelimitFeature extends EchofmBaseFeature
{
    ...
    private function _acquire(EchofmContext $ctx): void
    {
    ...
    private function _track(EchofmContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
