...
class EchofmCacheFeature extends EchofmBaseFeature
{
    ...
    private function _through(EchofmContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
