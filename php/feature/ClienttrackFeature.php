...
// Echofm SDK clienttrack feature
...
class EchofmClienttrackFeature extends EchofmBaseFeature
{
    ...
    public function PostConstruct(EchofmContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Echofm-SDK';
