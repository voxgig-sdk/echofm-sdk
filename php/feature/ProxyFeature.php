...
class EchofmProxyFeature extends EchofmBaseFeature
{
    ...
    public function init(EchofmContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EchofmContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
